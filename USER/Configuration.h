...
#define CV_PID_YAW_ANGLE_I_MAX		(5)	//积分最大值
#define CV_PID_YAW_ANGLE_I_Err		(20)	//积分分离值，差值在此值以内才进行积分
...
#define CV_PID_PITCH_ANGLE_I_MAX	(5)	//积分最大值
#define CV_PID_PITCH_ANGLE_I_Err	(20)	//积分分离值，差值在此值以内才进行积分

//CV_pitch 速度环pid
#define CV_PID_PITCH_SPEED_KP		(7.0f)
#define CV_PID_PITCH_SPEED_KI		(0.1f)
#define CV_PID_PITCH_SPEED_KD		(150.0f)
#define CV_PID_PITCH_SPEED_I_MAX	(400)	//积分最大值
#define CV_PID_PITCH_SPEED_I_Err	(100)	//积分分离值，差值在此值以内才进行积分
