...
PID_Controler CV_Yaw_Angle_PID={0};  //CV云台yaw轴角度环
PID_Controler CV_Pitch_Angle_PID ={0}; //CV云台pitch角度环
PID_Controler CV_Yaw_speed_pid={0};  //CV云台yaw轴速度环
PID_Controler CV_Pitch_speed_pid ={0}; //CV云台pitch速度环

// Kp centralization speed
// Ki 
// Kd centralize
...
void Total_PID_Init(void)
{
	...
	Pitch_speed_pid.Control_OutPut_Limit = 9000;//最大输出
	...
	//********CV云台yaw轴角度环*******//
	CV_Yaw_Angle_PID.Integrate_Limit_Flag = 1;//积分限幅
	CV_Yaw_Angle_PID.Integrate_Separation_Flag = 1;//积分分离
	CV_Yaw_Angle_PID.Integrate_Max = PID_YAW_ANGLE_I_MAX;//积分幅值
	CV_Yaw_Angle_PID.Integrate_Separation_Err = PID_YAW_ANGLE_I_Err;//积分分离范围
	CV_Yaw_Angle_PID.Kp = CV_PID_YAW_ANGLE_KP;
	CV_Yaw_Angle_PID.Ki = CV_PID_YAW_ANGLE_KI;
	CV_Yaw_Angle_PID.Kd = CV_PID_YAW_ANGLE_KD;
	CV_Yaw_Angle_PID.Control_OutPut_Limit = 30000;//最大输出
	
	
	
	//********CV云台pitch轴角度环******//
	CV_Pitch_Angle_PID.Integrate_Limit_Flag = 1;//积分限幅
	CV_Pitch_Angle_PID.Integrate_Separation_Flag = 1;//积分分离
	CV_Pitch_Angle_PID.Integrate_Max = PID_PITCH_ANGLE_I_MAX;//积分幅值
	CV_Pitch_Angle_PID.Integrate_Separation_Err = PID_PITCH_ANGLE_I_Err;//积分分离范围
	CV_Pitch_Angle_PID.Kp = CV_PID_PITCH_ANGLE_KP;
	CV_Pitch_Angle_PID.Ki = CV_PID_PITCH_ANGLE_KI;
	CV_Pitch_Angle_PID.Kd = CV_PID_PITCH_ANGLE_KD;
	CV_Pitch_Angle_PID.Control_OutPut_Limit = 30000;//最大输出
	
	
	/************CV云台yaw轴速度环***********/
	CV_Yaw_speed_pid.Integrate_Limit_Flag = 1;//积分限幅
	CV_Yaw_speed_pid.Integrate_Separation_Flag = 1;//积分分离
	CV_Yaw_speed_pid.Integrate_Max = CV_PID_YAW_SPEED_I_MAX;//积分幅值
	CV_Yaw_speed_pid.Integrate_Separation_Err = CV_PID_YAW_SPEED_I_Err;//积分分离范围
	CV_Yaw_speed_pid.Kp = CV_PID_YAW_SPEED_KP;
	CV_Yaw_speed_pid.Ki = CV_PID_YAW_SPEED_KI;
	CV_Yaw_speed_pid.Kd = CV_PID_YAW_SPEED_KD;
	CV_Yaw_speed_pid.Control_OutPut_Limit = 5000;//最大输出

	
	/************CV云台pitch轴速度环***********/
	CV_Pitch_speed_pid.Integrate_Limit_Flag = 1;//积分限幅
	CV_Pitch_speed_pid.Integrate_Separation_Flag = 1;//积分分离
	CV_Pitch_speed_pid.Integrate_Max = CV_PID_PITCH_SPEED_I_MAX;//积分幅值
	CV_Pitch_speed_pid.Integrate_Separation_Err = CV_PID_PITCH_SPEED_I_Err;//积分分离范围
	CV_Pitch_speed_pid.Kp = CV_PID_PITCH_SPEED_KP;
	CV_Pitch_speed_pid.Ki = CV_PID_PITCH_SPEED_KI;
	CV_Pitch_speed_pid.Kd = CV_PID_PITCH_SPEED_KD;
	CV_Pitch_speed_pid.Control_OutPut_Limit = 9000;//最大输出
