...
extern PID_Controler CV_Yaw_Angle_PID;  //CV云台yaw轴角度环
extern PID_Controler CV_Pitch_Angle_PID; //CV云台pitch角度环
extern PID_Controler CV_Yaw_speed_pid;		//CV云台yaw轴速度环
extern PID_Controler CV_Pitch_speed_pid;  //CV云台pitch轴速度环
