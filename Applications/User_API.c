...
{
	if(RC_Ctl.rc.s2 == RC_SW_DOWN && RC_Ctl.rc.s1 == RC_SW_UP)//遥控器 Up Down
	{
		...
		Control_data.Yaw_angle = (float)(RC_Ctl.rc.ch2 - 1024 + RC_ch2_Offset)/2660*25;
		Control_data.Pitch_angle = (float)(RC_Ctl.rc.ch3 - 1024 + RC_ch3_Offset)/660*REMOTE_Pitch_Angle;/// para modified for test, wait for changing back
	...
	else if(RC_Ctl.rc.s2 == RC_SW_DOWN && RC_Ctl.rc.s1 == RC_SW_MID)//遥控器 Mid Down
	{
		Control_data.Vx = -(float)(RC_Ctl.rc.ch1 - 1024 + RC_ch1_Offset)/660*REMOTE_Vx_MAX;
		Control_data.Vy = -(float)(RC_Ctl.rc.ch0 - 1024 + RC_ch0_Offset)/660*REMOTE_Vy_MAX;
		Control_data.Wz = (float)(RC_Ctl.rc.ch2 - 1024 + RC_ch2_Offset)/660*REMOTE_Wz_MAX;	//角速度，单位rad/s
	...
	else if (RC_Ctl.rc.s2 == RC_SW_DOWN && RC_Ctl.rc.s1 == RC_SW_DOWN){//遥控器 Down Down		
		Control_data.Vx = -(float)(RC_Ctl.rc.ch1 - 1024 + RC_ch1_Offset)/1660*REMOTE_Vx_MAX;
		Control_data.Vy = -(float)(RC_Ctl.rc.ch0 - 1024 + RC_ch0_Offset)/1660*REMOTE_Vy_MAX;
		Control_data.Wz = (float)(RC_Ctl.rc.ch2 - 1024 + RC_ch2_Offset)/660*REMOTE_Wz_MAX;	//角速度，单位rad/s
		Control_data.Pitch_angle = (float)(RC_Ctl.rc.ch3 - 1024 + RC_ch3_Offset)/660*REMOTE_Pitch_Angle;/// para modified for test, wait for changing back
