...
extern void Encoder_angle_conversion();
...
extern void cv_yaw_pitch_autorotate(float target_yaw_angle, float target_pitch_angle);
extern void Chassis_AutoRotate(float Vx, float Vy, float Wz, uint16_t shoot_speed);
extern void bprotect_fire_speed(int speed_mode,int targetSpeed);
